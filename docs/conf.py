...
"""
enrollment-email documentation build configuration file.
...
project = 'enrollment-email'
copyright = edx_theme.COPYRIGHT  # pylint: disable=redefined-builtin
author = edx_theme.AUTHOR
project_title = 'Enrollment e-mail'
...
#
# html_title = 'enrollment-email v0.1.0'
...
texinfo_documents = [
    (master_doc, project_title, documentation_title,
     author, project_title, 'Send an e-mail to staff every time a student enrolls into a course',
     'Miscellaneous'),
]
...
def on_init(app):  # pylint: disable=unused-argument
    ...
    check_call([apidoc_path, '-o', docs_path, os.path.join(root_path, 'enrollment_email'),
                os.path.join(root_path, 'enrollment_email/migrations')])
